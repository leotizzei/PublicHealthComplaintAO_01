...
class Date implements IDateDt{
	public static void main(String args[]) {
		try {
			Calendar agora = Calendar.getInstance();
			IDateDt d = new Date(agora.get(Calendar.DAY_OF_MONTH), agora.get(Calendar.MONTH), agora
					.get(Calendar.YEAR));
	...
	public void addDias(IDateDt data, int dias) throws InvalidDateException {
		...
		data = new Date(horario.getSegundo(), horario.getMinuto(), horario.getHora(), novaData.getDia(), novaData.getMes(), novaData.getAno());

...
public class ServletUpdateComplaintSearch extends HttpServlet {
        ...
        try {
            ...
            if (repTP==null||!repTP.hasNext()) {                
                ...
                do {
                    ...
                    System.out.println("[ServletUpdateComplaintSearch:doGet()] codigo="+tp.getCodigo()+" descricao="+tp.getDescricao());
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            System.out.println("[ServletUpdateComplaintSearch:doPost()] q.getSituacao()="+q.getSituacao()+" == "+Constants.OPEN_COMPLAINT);
